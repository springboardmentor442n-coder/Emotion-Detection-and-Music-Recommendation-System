...
### Milestone 2: Emotion Detection System
...
### Milestone 4: User Interface & Deployment
...
## 🛠️ Installation & Setup
   ...
   pip install -r Milestone_4_Frontend/requirements.txt



Run Backend (Terminal 1):

cd Milestone_3_Backend
...
Trained Model (model.keras): Link found in Milestone_2_Model/Keras-Model_Link.txt

Music Dataset (spotify_millsongdata.csv): Link found in Milestone_1_Data/spotify_millsongdata.txt
